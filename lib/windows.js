...
const winBinPath = arch() === 'x64' ?
	path.join(__dirname.replace('app.asar', 'app.asar.unpacked'), '../fallbacks/windows/clipboard_x86_64.exe') :
	path.join(__dirname.replace('app.asar', 'app.asar.unpacked'), '../fallbacks/windows/clipboard_i686.exe');
